...
namespace KillerFind
{
    ...
    public class HtmlExporter
    {
                           ...
                           string              rootPath)
        {
            ...
            sb.AppendLine("<title>KillerFind Report</title>");
            sb.AppendLine("<style>");

            // Per-theme variable blocks (KillerFind's brand accent is blue on the neutrals).
            ...
            sb.AppendLine($"<img class='logo' src='{AssetBase}killerfind-wordmark.png' alt='' onload=\"document.getElementById('wm').style.display='none'\" onerror=\"this.style.display='none'\"/>");
            sb.AppendLine("<span id='wm' class='wordmark'><span class='k'>Killer</span><span class='s'>Find</span></span>");
            ...
            string genBy = string.Format(L("Str_Rpt_GenBy", "Generated by {0}"),
                $"<a href='{SiteUrl}' target='_blank' rel='noopener'>KillerFind</a>");
