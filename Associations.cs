...
namespace KillerFind
{
    ...
    {
        internal const string AssocProgId  = "KillerFind.Document";
        internal const string AssocAppName = "KillerFind";
        ...
        private const string VerbOpen = "KillerFind";
        private const string VerbTerm = "KillerFindTerminal";
        private const string VerbEdit = "KillerFindEdit";
        ...
        /// the Capabilities block that puts KillerFind in Settings' Default apps list.
        ...
        // OpenWithProgids is the non-destructive half of this: it puts KillerFind in the
        ...
        private static void WriteEditVerbs(RegistryKey root, string exe)
        {
            foreach (var (_, shellProgId) in EditOnlyExtensions)
            {
                ...
                v.SetValue("", "Edit with KillerFind");
        ...
        private static void WriteFolderVerbs(RegistryKey root, string exe)
        {
            ...
            foreach (var (owner, token) in new[] { ("Directory", "%1"), ("Directory\\Background", "%V") })
            {
                ...
                v.SetValue("", "Open KillerFind terminal here");
                v.SetValue("Icon", exe + ",0");
                using var c = v.CreateSubKey("command");
        ...
        // Capabilities + RegisteredApplications is what actually makes KillerFind appear in
        ...
        {
            using (var cap = root.CreateSubKey(@"Software\KillerFind\Capabilities"))
            {
            ...
            reg.SetValue(AssocAppName, @"Software\KillerFind\Capabilities");
        }
        ...
        internal static bool UnregisterAssociations(bool machine)
        {
            ...
            ok &= Kill(root, @"Software\KillerFind\Capabilities");
