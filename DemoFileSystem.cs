    ...
    internal static class DemoFs
    {
        ...
        static DemoFs()
        {
            ...
            Add(@"C:\Users\steve",
                ...
                D("Videos",    2026, 2, 8),
                F("KillerFind.lnk", 2 * Kb,  2026, 7, 1),
            ...
            Add(@"C:\Users\steve\Documents\Exports",
                ...
                F("killerfind-report.html",   780 * Kb, 2026, 6, 30),
            ...
            Add(@"C:\Users\steve\Logs",
                ...
                F("killerfind.log",                  18 * Kb, 2026, 7, 3),
            ...
            Add(@"C:\Users\steve\Pictures",
                ...
                F("logo-killerfind.png",   180 * Kb, 2026, 3, 30),
                F("rack-fairview.jpg",    4200 * Kb, 2026, 6, 14),
                F("wallpaper.jpg",        3600 * Kb, 2026, 1, 3));

            Add(@"C:\Users\steve\Pictures\Screenshots",
                F("kf-browse.png",   1800 * Kb, 2026, 7, 2),
                F("kf-icons.png",    2400 * Kb, 2026, 7, 2),
                F("kf-search.png",   1600 * Kb, 2026, 7, 2),
                F("kf-terminal.png", 1200 * Kb, 2026, 7, 2),
                F("kf-tree.png",      940 * Kb, 2026, 7, 2));
            ...
            Add(@"C:\Users\steve\code\KillerFind",
                D("Models",   2026, 7, 3),
                D("Services", 2026, 7, 3),
                D("Strings",  2026, 6, 26),
                D("Terminal", 2026, 7, 2),
                F("CHANGELOG.md",      24 * Kb, 2026, 7, 3),
                F("KillerFind.csproj",  6 * Kb, 2026, 7, 1),
                F("KillerFind.sln",     2 * Kb, 2026, 4, 4),
            ...
            Add(@"D:\Images",
                ...
                F("WinPE-KillerFind.iso",                   900 * Mb,  2026, 5, 22));
