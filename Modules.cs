...
//
// Both are embedded resources (see the csproj) rather than files beside the app: KillerFind is
...
// KillerFind upgrade re-writes the modules instead of leaving an old copy in place forever.
namespace KillerFind
{
    public partial class MainWindow
    {
        ...
        /// a later KillerFind would never replace the one unpacked by an earlier one, because
        /// the check below is "does the folder exist".
        /// </summary>
        private static string ModulesRoot() => Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
            "KillerFind", "Modules", AppVersion());
