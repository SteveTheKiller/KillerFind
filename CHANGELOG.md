...
- Ctrl+E puts the caret in the search box, as it does in Explorer. Export moved to F9 for HTML and F8 for CSV - single keys rather than chords. Adding a filter moved from Ctrl+Shift+N to F7, because New Folder wanted its Explorer chord back.
